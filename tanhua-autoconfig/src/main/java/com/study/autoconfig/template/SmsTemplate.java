...
public class SmsTemplate {
    ...
    public void sendMessage(String phone, String code) {
        try {
            Credential cred = new Credential(smsProperties.getAccessKey(), smsProperties.getSecret());
            ...
            String templateId = smsProperties.getTemplateCode();
